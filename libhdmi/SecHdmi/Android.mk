...
ifeq ($(BOARD_USES_FIMGAPI),true)
	...
	LOCAL_C_INCLUDES += hardware/samsung_slsi/$(TARGET_BOARD_PLATFORM)/libfimg4x
...
ifeq ($(BOARD_USES_HDMI_EDID),true)
	LOCAL_CFLAGS += -DBOARD_USES_HDMI_EDID
endif

ifeq ($(BOARD_USES_HDMI_JUMPER),true)
	LOCAL_CFLAGS += -DBOARD_USES_HDMI_JUMPER
endif
